...
public class search extends javax.swing.JInternalFrame {
   ...
   String selectorderid =null;
    public search(String serchword) {
        initComponents();
                    ...
                    try(ResultSet rs =cst.getResultSet()){
                        ...
                        while(rs.next()){
                            ...
                            if(count!=0 && count!=1 && count!=2 &&(count%3 == 0)){
                             ...
                             int qun=rs.getInt("item_quntity");
                             String state =rs.getString("item_state");
                             if(qun != 0 && state.equals("Yes")){
                                 ...
                                 jLabela.setIcon(new javax.swing.ImageIcon(getClass().getResource(rs.getString("item_img")))); 
                                 ...
                                 jLabelb.setText(rs.getString("item_name")+"("+rs.getString("item_catagory")+")");
                                 ...
                                 jLabelc.setText("Rs:"+rs.getString("item_price"));
