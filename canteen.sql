...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 24, 2021 at 02:49 PM
...
(9, 2, 3, '2021-06-07', '11 30 AM', 21, 'Room 08', 'Reseve', 1),
...
DROP EVENT `mondelqunupdate`$$
CREATE DEFINER=`root`@`localhost` EVENT `mondelqunupdate` ON SCHEDULE EVERY 1 MONTH STARTS '2021-06-30 23:59:59' ENDS '2023-06-07 23:57:59' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE deliver SET deliver_qun_month= 0 WHERE 1$$
